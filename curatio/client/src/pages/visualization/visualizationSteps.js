...
const STEP_DEFS = [
  { step: 1, section: 'Clinical Context', title: 'Clinical Scenario', stageLabel: 'Patient intake', caption: 'A patient describes symptoms in plain language — unstructured text enters triage.', durationMs: 20000, equations: [], formulaTerms: [] },
  { step: 2, section: 'Clinical Context', title: 'Dual Pathway', stageLabel: 'Dual pathway', caption: 'Vitals scoring and language analysis run in parallel, then fuse into one colour.', durationMs: 20000, equations: [], formulaTerms: [] },
  { step: 3, section: 'Clinical Context', title: 'Supervised Pipeline', stageLabel: 'Full pipeline', caption: 'Text flows through tokenize → embed → encode → classify to pick a SATS colour.', durationMs: 20000, equations: [], formulaTerms: [] },
  {
    step: 4, section: 'NLP Pipeline', title: 'Tokenization', stageLabel: 'Tokenize',
    caption: 'The complaint splits into WordPiece tokens, each mapped to a vocabulary ID.', durationMs: 20000,
    equations: [{ latex: TOKENIZATION_TAU }],
    formulaTerms: [{ id: 'tau', label: 'τ(·)' }, { id: 'id', label: 'id(t_i)' }, { id: 'vocab', label: 'V = 30k' }],
  },
  { step: 5, section: 'NLP Pipeline', title: '[CLS] Token', stageLabel: '[CLS] slot', caption: '[CLS] sits at position 0 — after 12 layers it holds the whole-sentence summary.', durationMs: 20000, equations: [], formulaTerms: [] },
  {
    step: 6, section: 'NLP Pipeline', title: 'Embedding Lookup', stageLabel: 'Embed lookup',
    caption: 'Each token ID looks up a row of 768 numbers that encode meaning.', durationMs: 20000,
    equations: [{ latex: EMBEDDING_LOOKUP }],
    formulaTerms: [{ id: 'E_word', label: 'E_word' }, { id: 'id', label: 'id(t_i)' }, { id: 'e_i', label: 'e_i ∈ ℝ⁷⁶⁸' }],
  },
  { step: 7, section: 'NLP Pipeline', title: 'Vector Space', stageLabel: 'Vector space', caption: 'Similar clinical words cluster together in learned embedding space.', durationMs: 20000, equations: [], formulaTerms: [] },
  {
    step: 8, section: 'NLP Pipeline', title: 'Contextual Sum', stageLabel: 'Contextual sum',
    caption: 'Word, position, and segment embeddings add to form each token input.', durationMs: 20000,
  ...
  },
  {
    ...
    caption: 'Every token becomes one row — M tokens × 768 dimensions.', durationMs: 20000,
    equations: [{ latex: INPUT_MATRIX }],
    formulaTerms: [{ id: 'H0', label: 'H⁽⁰⁾' }, { id: 'M', label: 'M tokens' }, { id: '768', label: '768 dims' }],
  },
  { step: 10, section: 'NLP Pipeline', title: 'Encoder Stack', stageLabel: '12 layers', caption: 'Data rises through 12 transformer layers of self-attention and feed-forward.', durationMs: 20000, equations: [], formulaTerms: [] },
  {
    step: 11, section: 'NLP Pipeline', title: 'Inside One Layer', stageLabel: 'One layer',
    caption: 'Attention pulls context from feverish into headache; residuals preserve information.', durationMs: 20000,
  ...
  },
  {
    ...
    caption: 'Shallow layers read words; deep layers encode clinical urgency.', durationMs: 20000,
  ...
  },
  {
    ...
    caption: 'headache attends most to feverish (41%), then weak (18%) — symptoms link together.', durationMs: 20000,
  ...
  { step: 14, section: 'Pre-Training', title: 'Masked Language Modeling', stageLabel: 'MLM', caption: 'Before triage labels, BioBERT learns medicine by predicting masked words on PubMed.', durationMs: 20000, equations: [], formulaTerms: [] },
  {
    step: 15, section: 'Pre-Training', title: 'MLM Loss', stageLabel: 'MLM loss',
    caption: 'High confidence on the correct word means a small penalty; wrong guesses cost more.', durationMs: 20000,
  ...
  },
  {
    ...
    caption: 'Attention scores become probabilities that sum to 1 across all tokens.', durationMs: 20000,
  ...
  },
  {
    ...
    caption: 'The [CLS] summary vector maps to acuity probabilities — Yellow at 72%.', durationMs: 20000,
  ...
  },
  {
    ...
    caption: 'Training compares nurse labels to predictions — confident mistakes get large loss.', durationMs: 20000,
  ...
  },
  {
    ...
    caption: 'Error flows backward through all 12 layers to find which weights caused the mistake.', durationMs: 20000,
  ...
  },
  {
    ...
    caption: '80,000 labeled complaints tune BioBERT over 13,500 steps across 3 epochs.', durationMs: 20000,
  ...
  { step: 21, section: 'Summary', title: 'End-to-End', stageLabel: 'Yellow 72%', caption: 'Complaint → tokens → 12 layers → Yellow (72%) → fusion with vitals.', durationMs: 22000, equations: [], formulaTerms: [] },
];
